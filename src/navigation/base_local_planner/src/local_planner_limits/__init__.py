...
def add_generic_localplanner_params(gen):
    ...
    gen.add("max_vel_x", double_t, 0, "The maximum x velocity for the robot in m/s", 30.0)
    gen.add("min_vel_x", double_t, 0, "The minimum x velocity for the robot in m/s", 0.6)
